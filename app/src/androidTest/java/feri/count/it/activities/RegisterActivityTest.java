...
public class RegisterActivityTest
{
    ...
    @Test
    public void registerActivityEmptyEmail()
    {
    ...
    @Test
    public void registerActivityEmptyUsername()
    {
        ViewInteraction materialButton = onView(allOf(withId(R.id.buttonRegister), withText("+"), childAtPosition(childAtPosition(withId(android.R.id.content), 0), 5), isDisplayed()));
        materialButton.perform(click());
        ...
        ViewInteraction materialButton2 = onView(allOf(withId(R.id.button_next), withText("Next"), childAtPosition(allOf(withId(R.id.email_top_layout), childAtPosition(
                withClassName(is("android.widget.ScrollView")), 0)), 2)));
        materialButton2.perform(scrollTo(), click());
    ...
    @Test
    public void registerActivityEmptyPassword()
    {
        ViewInteraction materialButton = onView(allOf(withId(R.id.buttonRegister), withText("+"), childAtPosition(childAtPosition(withId(android.R.id.content), 0), 5), isDisplayed()));
        materialButton.perform(click());
        ...
        ViewInteraction appCompatEditText2 = onView(allOf(withId(R.id.edtEmailLog), childAtPosition(childAtPosition(withClassName(is("androidx.constraintlayout.widget.ConstraintLayout")), 2), 5),
                isDisplayed()));
    ...
    @Test
    public void registerActivityIncorrectPassword()
    {
        ViewInteraction materialButton = onView(allOf(withId(R.id.buttonRegister), withText("+"), childAtPosition(childAtPosition(withId(android.R.id.content), 0), 5), isDisplayed()));
        materialButton.perform(click());
